...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!$this->indexExists('deployments', 'deployments_project_server_status_created_at_idx')) {
        ...
        if (!$this->indexExists('server_metrics', 'server_metrics_server_created_idx')) {
        ...
        if (!$this->indexExists('server_metrics', 'server_metrics_resource_usage_idx')) {
            Schema::table('server_metrics', function (Blueprint $table) {
        ...
        if (!$this->indexExists('audit_logs', 'audit_logs_type_created_idx')) {
            Schema::table('audit_logs', function (Blueprint $table) {
        ...
        if (!$this->indexExists('domains', 'domains_project_ssl_idx')) {
        ...
        if (!$this->indexExists('domains', 'domains_ssl_expiration_idx')) {
            Schema::table('domains', function (Blueprint $table) {
        ...
        if (!$this->indexExists('projects', 'projects_status_updated_idx')) {
        ...
        if (!$this->indexExists('servers', 'servers_status_ping_idx')) {
        ...
        if (!$this->indexExists('deployments', 'deployments_status_created_idx')) {
            Schema::table('deployments', function (Blueprint $table) {
