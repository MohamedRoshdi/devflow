<div <?php if($dockerInstalling): ?> wire:poll.3s="checkDockerInstallProgress" <?php else: ?> wire:poll.30s <?php endif; ?>>
    <!-- Hero Section -->
        ...
        <div class="relative z-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white"><?php echo e($server->name); ?></h1>
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('servers.security', $server)); ?>" class="px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all duration-200 font-medium flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                        </svg>
                        Security
                    </a>
                    <a href="<?php echo e(route('servers.backups', $server)); ?>" class="px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-all duration-200 font-medium flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4"></path>
                        </svg>
                        Backups
                    </a>
                    <a href="<?php echo e(route('servers.metrics', $server)); ?>" class="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all duration-200 font-medium flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                        </svg>
                        Metrics Dashboard
                    </a>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $server)): ?>
                    <a href="<?php echo e(route('servers.edit', $server)); ?>" class="px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl transition-all duration-200 font-medium flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('servers.index')); ?>" class="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl transition-all duration-200 font-medium">
                        ← Back
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-8 transition-colors">
        <div class="flex items-center justify-between mb-6">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">
                Last ping: <?php echo e($server->last_ping_at ? $server->last_ping_at->diffForHumans() : 'Never'); ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <?php if(!$server->docker_installed): ?>
                <?php if($dockerInstalling): ?>
                    ...
                    <div class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-xl shadow-lg">
                        ...
                        <?php if($dockerInstallStatus): ?>
                            <span class="text-xs mt-1 opacity-80"><?php echo e($dockerInstallStatus['message'] ?? 'Please wait...'); ?></span>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
            ...
            <?php else: ?>
                <!-- Docker Dashboard -->
                <a href="<?php echo e(route('docker.dashboard', $server)); ?>"
                   class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
            ...
            <!-- SSL Certificates -->
            <a href="<?php echo e(route('servers.ssl', $server)); ?>"
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <div class="py-2">
                        ...
                        <?php $__currentLoopData = ['nginx', 'apache2', 'mysql', 'redis', 'php8.4-fpm', 'docker', 'supervisor']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button wire:click="restartService('<?php echo e($service); ?>')"
                                    wire:loading.attr="disabled"
                                    wire:target="restartService('<?php echo e($service); ?>')"
                                    @click="open = false"
                                ...
                                <svg wire:loading wire:target="restartService('<?php echo e($service); ?>')" class="animate-spin w-4 h-4 text-indigo-500" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                            </button>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold
                            <?php if($server->status === 'online'): ?> bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400
                            <?php elseif($server->status === 'maintenance'): ?> bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400
                            <?php else: ?> bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400
                            <?php endif; ?>">
                            <span class="w-2 h-2 rounded-full mr-2
                                <?php if($server->status === 'online'): ?> bg-green-500 animate-pulse
                                <?php elseif($server->status === 'maintenance'): ?> bg-yellow-500
                                <?php else: ?> bg-red-500
                                <?php endif; ?>"></span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($server->cpu_cores ?? '-'); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($server->memory_gb ?? '-'); ?> <span class="text-sm font-normal text-gray-500">GB</span></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 transition-colors">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold mt-1 <?php if($server->docker_installed): ?> text-green-600 dark:text-green-400 <?php else: ?> text-red-600 dark:text-red-400 <?php endif; ?>">
                        <?php if($server->docker_installed): ?>
                ...
                <div class="p-3 <?php if($server->docker_installed): ?> bg-green-100 dark:bg-green-900/30 <?php else: ?> bg-red-100 dark:bg-red-900/30 <?php endif; ?> rounded-xl">
                    <svg class="w-6 h-6 <?php if($server->docker_installed): ?> text-green-600 dark:text-green-400 <?php else: ?> text-red-600 dark:text-red-400 <?php endif; ?>" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="p-6">
                <dl class="space-y-4">
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white font-mono"><?php echo e($server->hostname); ?></dd>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">IP Address</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white font-mono"><?php echo e($server->ip_address); ?></dd>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">SSH Port</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($server->port); ?></dd>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Username</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white font-mono"><?php echo e($server->username); ?></dd>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Operating System</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($server->os ?? 'Unknown'); ?></dd>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Disk Space</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($server->disk_gb ?? '-'); ?> GB</dd>
                    </div>
                    <?php if($server->location_name): ?>
                        <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Location</dt>
                            <dd class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($server->location_name); ?></dd>
                        </div>
                    <?php endif; ?>
                    <div class="flex justify-between items-center py-3">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Added</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($server->created_at->format('M d, Y')); ?></dd>
                    </div>
                </dl>
            </div>
        </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($latestMetric->cpu_usage); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                                <div class="h-3 rounded-full transition-all duration-500
                                    ...
                                    <?php endif; ?>" style="width: <?php echo e($latestMetric->cpu_usage); ?>%"></div>
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Memory Usage</span>
                                <span class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($latestMetric->memory_usage); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                                <div class="h-3 rounded-full transition-all duration-500
                                    ...
                                    <?php endif; ?>" style="width: <?php echo e($latestMetric->memory_usage); ?>%"></div>
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Disk Usage</span>
                                <span class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($latestMetric->disk_usage); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                                <div class="h-3 rounded-full transition-all duration-500
                                    ...
                                    <?php endif; ?>" style="width: <?php echo e($latestMetric->disk_usage); ?>%"></div>
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-4">
                            Last updated: <?php echo e($latestMetric->recorded_at->diffForHumans()); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl transition-colors overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-750 flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($projects->count()); ?> total</span>
            </div>
            <div class="p-6">
                            ...
                            <a href="<?php echo e(route('projects.show', $project)); ?>"
                               class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors group">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"><?php echo e($project->name); ?></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($project->domain ?? 'No domain'); ?></p>
                                    </div>
                                </div>
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    <?php if($project->status === 'running'): ?> bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400
                                    <?php elseif($project->status === 'stopped'): ?> bg-gray-100 text-gray-600 dark:bg-gray-600 dark:text-gray-300
                                    <?php elseif($project->status === 'building'): ?> bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400
                                    <?php elseif($project->status === 'failed'): ?> bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('projects.create')); ?>" class="inline-flex items-center mt-4 text-sm text-blue-600 dark:text-blue-400 hover:underline">
                            + Create a project
                        </a>
                    </div>
                <?php endif; ?>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center
                                        <?php if($deployment->status === 'success'): ?> bg-green-100 dark:bg-green-900/30
                                        <?php elseif($deployment->status === 'failed'): ?> bg-red-100 dark:bg-red-900/30
                                        <?php else: ?> bg-yellow-100 dark:bg-yellow-900/30
                                        <?php endif; ?>">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($deployment->project->name); ?></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($deployment->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    <?php if($deployment->status === 'success'): ?> bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400
                                    <?php elseif($deployment->status === 'failed'): ?> bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400
...
[$__name, $__params] = $__split('servers.server-tag-assignment', ['server' => $server]);

$__html = app('livewire')->mount($__name, $__params, 'lw-947842754-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl transition-colors overflow-hidden">
        <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-900 to-slate-800">
            ...
            <p class="text-sm text-gray-400 mt-1">Execute commands directly on <?php echo e($server->name); ?></p>
        </div>
        <div class="p-6">
            <?php
$__split = function ($name, $params = []) {
...
[$__name, $__params] = $__split('servers.s-s-h-terminal', ['server' => $server]);

$__html = app('livewire')->mount($__name, $__params, 'lw-947842754-1', $__slots ?? [], get_defined_vars());
