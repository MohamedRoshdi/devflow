                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <?php endswitch; ?>
                            <div class="ml-3">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($channel->name); ?></h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(ucfirst($channel->provider)); ?></p>
                            </div>
                        </div>
                        <button wire:click="toggleChannel(<?php echo e($channel->id); ?>)"
                                wire:loading.attr="disabled"
                                wire:loading.class="opacity-50"
                                wire:target="toggleChannel(<?php echo e($channel->id); ?>)"
                                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                                <?php echo e($channel->enabled ? 'bg-green-600' : 'bg-gray-300'); ?>">
                            <span class="inline-block h-5 w-5 transform rounded-full bg-white transition-transform
                                <?php echo e($channel->enabled ? 'translate-x-5' : 'translate-x-0.5'); ?>"></span>
                        </button>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-wrap gap-1">
                            <?php $__currentLoopData = $channel->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded text-xs">
                                    <?php echo e(str_replace('_', ' ', ucwords($event))); ?>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t dark:border-gray-700">
                        <button wire:click="testChannel(<?php echo e($channel->id); ?>)"
                                wire:loading.attr="disabled"
                                wire:loading.class="opacity-50"
                                wire:target="testChannel(<?php echo e($channel->id); ?>)"
                                class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300 text-sm font-medium">
                            <span wire:loading.remove wire:target="testChannel(<?php echo e($channel->id); ?>)">Test</span>
                            <span wire:loading wire:target="testChannel(<?php echo e($channel->id); ?>)">Testing...</span>
                        </button>
                        <div class="flex space-x-3">
                            <button wire:click="editChannel(<?php echo e($channel->id); ?>)"
                                    wire:loading.attr="disabled"
                                    wire:loading.class="opacity-50"
                                    wire:target="editChannel(<?php echo e($channel->id); ?>)"
                            ...
                            <button wire:click="deleteChannel(<?php echo e($channel->id); ?>)"
                                    wire:loading.attr="disabled"
                                    wire:loading.class="opacity-50"
                                    wire:target="deleteChannel(<?php echo e($channel->id); ?>)"
                                    wire:confirm="Are you sure you want to delete this channel?"
                                    class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 text-sm">
                                <span wire:loading.remove wire:target="deleteChannel(<?php echo e($channel->id); ?>)">Delete</span>
                                <span wire:loading wire:target="deleteChannel(<?php echo e($channel->id); ?>)">Deleting...</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <form wire:submit.prevent="saveChannel">
                        <div class="px-6 py-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
                                <?php echo e($editingChannel ? 'Edit Notification Channel' : 'Add Notification Channel'); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-4 gap-3">
                                        <?php $__currentLoopData = ['slack' => 'Slack', 'discord' => 'Discord', 'teams' => 'Teams', 'webhook' => 'Webhook']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex flex-col items-center p-3 border rounded-lg cursor-pointer
                                                <?php echo e($provider === $value ? 'border-purple-500 bg-purple-50 dark:bg-purple-900' : 'border-gray-300 dark:border-gray-600'); ?>">
                                                <input type="radio" wire:model="provider" value="<?php echo e($value); ?>" class="sr-only">
                                                <span class="text-sm font-medium <?php echo e($provider === $value ? 'text-purple-900 dark:text-purple-100' : 'text-gray-900 dark:text-gray-100'); ?>">
                                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <?php $__currentLoopData = $availableEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventKey => $eventName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="inline-flex items-center">
                                                <input type="checkbox"
                                                       wire:click="toggleEvent('<?php echo e($eventKey); ?>')"
                                                       <?php if(in_array($eventKey, $events)): ?> checked <?php endif; ?>
                                                       class="rounded border-gray-300 text-purple-600">
                                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300"><?php echo e($eventName); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <?php $__errorArgs = ['events'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 px-6 py-3 flex justify-end space-x-3">
                            ...
                            <button type="submit"
                                ...
                                <span wire:loading.remove wire:target="saveChannel"><?php echo e($editingChannel ? 'Update Channel' : 'Add Channel'); ?></span>
...
</div><?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/notifications/channel-manager.blade.php ENDPATH**/ ?>