        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white/80"><?php echo e($server->name); ?> - UFW Configuration</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap gap-3">
                    ...
                    <?php if($ufwInstalled && $ufwEnabled): ?>
        ...
        <?php if(!$ufwInstalled): ?>
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-8 text-center">
                ...
                <?php if($statusMessage): ?>
                    <p class="text-yellow-400 text-sm mb-4"><?php echo e($statusMessage); ?></p>
                <?php endif; ?>
                ...
                <?php if($rawOutput): ?>
                    <div class="mb-6 text-left max-w-lg mx-auto">
                        <details class="bg-gray-900/50 rounded-lg p-3">
                            ...
                            <pre class="mt-2 text-xs text-gray-500 overflow-x-auto whitespace-pre-wrap"><?php echo e($rawOutput); ?></pre>
                        </details>
                    </div>
                <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="p-3 rounded-lg <?php echo e($ufwEnabled ? 'bg-green-500/20' : 'bg-red-500/20'); ?>">
                            <svg class="w-8 h-8 <?php echo e($ufwEnabled ? 'text-green-400' : 'text-red-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400">
                                UFW is currently
                                <span class="font-medium <?php echo e($ufwEnabled ? 'text-green-400' : 'text-red-400'); ?>">
                                    <?php echo e($ufwEnabled ? 'Active' : 'Inactive'); ?>
                                ...
                                <tbody class="divide-y divide-gray-700/50">
                                    <?php $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-gray-300">
                                            <td class="py-3 text-gray-500"><?php echo e($rule['number']); ?></td>
                                            <td class="py-3"><?php echo e($rule['parsed']['to'] ?: 'Anywhere'); ?></td>
                                            <td class="py-3">
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                    <?php echo e($rule['parsed']['action'] === 'allow' ? 'bg-green-500/20 text-green-400' : ''); ?>

                                                    <?php echo e($rule['parsed']['action'] === 'deny' ? 'bg-red-500/20 text-red-400' : ''); ?>

                                                    <?php echo e($rule['parsed']['action'] === 'reject' ? 'bg-orange-500/20 text-orange-400' : ''); ?>

                                                    <?php echo e($rule['parsed']['action'] === 'limit' ? 'bg-yellow-500/20 text-yellow-400' : ''); ?>">
                                                    <?php echo e(strtoupper($rule['parsed']['action'])); ?>

                                                </span>
                                            </td>
                                            <td class="py-3"><?php echo e($rule['parsed']['from'] ?: 'Anywhere'); ?></td>
                                            <td class="py-3 text-right">
                                                <button wire:click="deleteRule(<?php echo e($rule['number']); ?>)"
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/servers/security/firewall-manager.blade.php ENDPATH**/ ?>