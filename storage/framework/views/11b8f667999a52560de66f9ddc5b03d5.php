        ...
        <div class="mx-auto w-full max-w-[1560px] px-6 md:px-10 lg:px-16">
            <div class="flex h-20 items-center justify-between rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-sm shadow-blue-500/5 mt-6 px-6">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('home')); ?>" wire:navigate class="hidden md:inline-flex px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
                        Portfolio
                    </a>
        ...
        <main class="flex-1 mt-28 sm:mt-32">
            <section class="relative overflow-hidden py-40">
                ...
                <div class="relative z-10 mx-auto w-full max-w-[1560px] px-6 md:px-10 lg:px-16 text-center">
                    ...
                    <div class="mt-10">
                        <a href="<?php echo e(route('home')); ?>" wire:navigate class="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-900 shadow-xl shadow-slate-900/20 transition hover:-translate-y-0.5 hover:shadow-2xl">
        ...
        <main class="flex-1 mt-28 sm:mt-32">
            ...
            <section class="relative overflow-hidden py-40">
                ...
                <div class="relative z-10 mx-auto w-full max-w-[1560px] px-6 md:px-10 lg:px-16">
                    <!-- Back Link -->
                    <div class="mb-8">
                        <a href="<?php echo e(route('home')); ?>" wire:navigate class="inline-flex items-center gap-2 text-sm font-medium text-white/80 hover:text-white transition-colors">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                            </svg>
                            Back to Portfolio
                    ...
                    <div class="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                        <div>
                            ...
                            <div class="mt-6 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur">
                                ...
                                <?php endif; ?>
                                <span><?php echo e($project->framework ?? 'Framework'); ?></span>
                            </div>

                            <!-- Description (if available from metadata) -->
                            <?php if($project->metadata && isset($project->metadata['description'])): ?>
                                <p class="mt-6 text-lg text-white/80 sm:text-xl lg:max-w-xl">
                                    <?php echo e($project->metadata['description']); ?>
                            ...
                            <?php if($url): ?>
                                <div class="mt-10">
                                    <a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-base font-semibold text-slate-900 shadow-xl shadow-slate-900/20 transition hover:-translate-y-0.5 hover:shadow-2xl">
                                        Visit Live Project
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="relative space-y-6">
                                    ...
                                    <?php if($primaryDomain): ?>
                                        <div class="flex items-start gap-3 rounded-2xl bg-black/20 p-4 ring-1 ring-white/10">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-sm font-semibold text-white break-all"><?php echo e($primaryDomain); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2">
                                        <?php if($project->php_version): ?>
                                            <div class="rounded-2xl bg-white/10 p-4 text-white">
                                                ...
                                                <p class="text-lg font-semibold"><?php echo e($project->php_version); ?></p>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if($project->environment): ?>
                                            <div class="rounded-2xl bg-white/10 p-4 text-white">
                                                ...
                                                <p class="text-lg font-semibold capitalize"><?php echo e($project->environment); ?></p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if($project->created_at): ?>
                                        <div class="rounded-2xl bg-white/10 p-4 text-white">
                                            ...
                                            <p class="text-sm font-semibold"><?php echo e($project->created_at->format('F j, Y')); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <section class="py-24 bg-white dark:bg-slate-900">
                <div class="mx-auto w-full max-w-[1560px] px-6 md:px-10 lg:px-16">
                    ...
                    <div class="mt-16 text-center">
                        <a href="<?php echo e(route('home')); ?>" wire:navigate class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/10 transition hover:-translate-y-0.5 hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                            </svg>
                            View More Projects
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/home/project-detail.blade.php ENDPATH**/ ?>