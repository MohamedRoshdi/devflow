        ...
        <div class="flex gap-8">
            ...
            <div class="w-64 flex-shrink-0">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden sticky top-6">
                    ...
                    <nav class="p-2">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $groupName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button wire:click="setActiveGroup('<?php echo e($groupKey); ?>')"
                                    class="w-full flex items-center px-4 py-3 text-left rounded-lg transition-colors <?php echo e($activeGroup === $groupKey ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'); ?>">
                                <!--[if BLOCK]><![endif]--><?php switch($groupKey):
                                    case ('general'): ?>
                                ...
                                <span class="font-medium"><?php echo e($groupName); ?></span>
                            </button>
            ...
            <div class="flex-1">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->groupedSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $groupSettings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-show="$wire.activeGroup === '<?php echo e($group); ?>'"
                        ...
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center space-x-3">
                                <div class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
                                    <!--[if BLOCK]><![endif]--><?php switch($group):
                                        case ('general'): ?>
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($this->groups[$group] ?? ucfirst($group)); ?></h2>
                        ...
                        <div class="p-6 space-y-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $groupSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($setting->type === 'boolean'): ?>
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                                        <div class="flex items-center space-x-3">
                                            <div class="p-2 rounded-lg <?php echo e(isset($settings[$setting->key]) && $settings[$setting->key] ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-200 dark:bg-gray-600'); ?>">
                                                <svg class="w-5 h-5 <?php echo e(isset($settings[$setting->key]) && $settings[$setting->key] ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                </svg>
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-900 dark:text-white"><?php echo e($setting->getDisplayLabel()); ?></label>
                                        ...
                                        <button type="button" wire:click="toggleSetting('<?php echo e($setting->key); ?>')"
                                                class="relative inline-flex h-8 w-14 rounded-full transition-colors <?php echo e(isset($settings[$setting->key]) && $settings[$setting->key] ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600'); ?>">
                                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform <?php echo e(isset($settings[$setting->key]) && $settings[$setting->key] ? 'translate-x-7' : 'translate-x-1'); ?> mt-1 shadow-lg"></span>
                                        </button>
                                    </div>
                                <?php elseif($setting->type === 'integer'): ?>
                                    ...
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                        ...
                                        <input type="number"
                                               wire:model="settings.<?php echo e($setting->key); ?>"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($groupSettings->isEmpty()): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($saveSuccess): ?>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/settings/system-settings.blade.php ENDPATH**/ ?>