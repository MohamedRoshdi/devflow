<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center <?php echo e($step < 4 ? 'flex-1' : ''); ?>">
                    <button wire:click="goToStep(<?php echo e($step); ?>)"
                            class="flex items-center justify-center w-10 h-10 rounded-full transition-all
                                <?php echo e($currentStep == $step ? 'bg-blue-600 text-white' : ($currentStep > $step ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400')); ?>

                                <?php echo e($currentStep >= $step ? 'cursor-pointer hover:scale-105' : 'cursor-not-allowed'); ?>">
                        ...
                        <?php else: ?>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($info['icon']); ?>"/>
                            </svg>
                        <?php endif; ?>
                    </button>
                    <span class="ml-2 text-sm font-medium <?php echo e($currentStep >= $step ? 'text-gray-900 dark:text-white' : 'text-gray-400 dark:text-gray-500'); ?>">
                        <?php echo e($info['title']); ?>

                    </span>
                    <?php if($step < 4): ?>
                        <div class="flex-1 h-0.5 mx-4 <?php echo e($currentStep > $step ? 'bg-green-500' : 'bg-gray-200 dark:bg-gray-700'); ?>"></div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button"
                                    wire:click="selectTemplate(<?php echo e($template->id); ?>)"
                                    class="p-3 rounded-lg border-2 text-center transition-all
                                        <?php echo e($selectedTemplateId == $template->id
                                            ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30'
                                            : 'border-gray-200 dark:border-gray-600 hover:border-blue-300'); ?>">
                                    <p class="font-medium text-gray-900 dark:text-white text-sm"><?php echo e($template->name); ?></p>
                                </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php if($selectedTemplateId): ?>
...
unset($__errorArgs, $__bag); ?>">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">URL: <?php echo e($slug); ?>.nilestack.duckdns.org</p>
                        ...
                        <div class="space-y-2 max-h-64 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $servers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all
                                    <?php echo e($server_id == $server->id ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-gray-200 dark:border-gray-700 hover:border-blue-300'); ?>">
                                    <input type="radio" wire:model="server_id" value="<?php echo e($server->id); ?>" class="h-4 w-4 text-blue-600">
                                    <div class="ml-3 flex-1">
                                        <div class="flex items-center">
                                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e($server->name); ?></span>
                                            <span class="ml-2 px-2 py-0.5 rounded text-xs
                                                <?php if($server->status === 'online'): ?> bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300
                                                <?php else: ?> bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 <?php endif; ?>">
                                                <?php echo e(ucfirst($server->status)); ?>

                                            </span>
                                        </div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($server->ip_address); ?></span>
                                    </div>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p class="text-yellow-600 text-sm p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
                                    No servers available. <a href="<?php echo e(route('servers.create')); ?>" class="underline font-medium">Add a server first</a>
                                </p>
                            <?php endif; ?>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select wire:model="framework" id="framework" class="input">
                                <?php $__currentLoopData = $this->frameworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div>
                            ...
                            <select wire:model="php_version" id="php_version" class="input">
                                <?php $__currentLoopData = $this->phpVersions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableSsl ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                        ...
                        <!-- Git Webhooks -->
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableWebhooks ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                        ...
                        <!-- Health Checks -->
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableHealthChecks ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                        ...
                        <!-- Database Backups -->
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableBackups ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                        ...
                        <!-- Notifications -->
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableNotifications ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                        ...
                        <!-- Auto Deploy -->
                        <label class="flex items-start p-4 border rounded-lg cursor-pointer transition-all hover:border-blue-300
                            <?php echo e($enableAutoDeploy ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700'); ?>">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div><span class="text-gray-500 dark:text-gray-400">Name:</span> <span class="text-gray-900 dark:text-white"><?php echo e($name); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">Slug:</span> <span class="text-gray-900 dark:text-white"><?php echo e($slug); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">Server:</span> <span class="text-gray-900 dark:text-white"><?php echo e($servers->find($server_id)?->name ?? 'Not selected'); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">Branch:</span> <span class="text-gray-900 dark:text-white"><?php echo e($branch); ?></span></div>
                                <div class="col-span-2"><span class="text-gray-500 dark:text-gray-400">Repository:</span> <span class="text-gray-900 dark:text-white text-xs break-all"><?php echo e($repository_url); ?></span></div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div><span class="text-gray-500 dark:text-gray-400">Framework:</span> <span class="text-gray-900 dark:text-white"><?php echo e($framework ?: 'Not specified'); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">PHP:</span> <span class="text-gray-900 dark:text-white"><?php echo e($php_version); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">Node:</span> <span class="text-gray-900 dark:text-white"><?php echo e($node_version); ?></span></div>
                                <div><span class="text-gray-500 dark:text-gray-400">Root:</span> <span class="text-gray-900 dark:text-white"><?php echo e($root_directory); ?></span></div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <?php endif; ?>
                                <?php if(!$enableSsl && !$enableWebhooks && !$enableHealthChecks && !$enableBackups && !$enableNotifications && !$enableAutoDeploy): ?>
    ...
    <?php if($showProgressModal && $createdProjectId): ?>
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" wire:poll.2s="$refresh">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
                ...
                <?php $progress = $this->setupProgress; ?>
                <?php if(!empty($progress['tasks'])): ?>
                    <div class="space-y-3 mb-6">
                        <?php $__currentLoopData = $progress['tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                ...
                                <?php endif; ?>
                                <span class="text-sm <?php echo e($task['status'] === 'completed' ? 'text-green-600 dark:text-green-400' : ($task['status'] === 'running' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400')); ?>">
                ...
                <div class="flex justify-end">
                    <button wire:click="closeProgressAndRedirect"
                            class="btn btn-primary <?php echo e(($progress['status'] ?? '') !== 'completed' && ($progress['status'] ?? '') !== 'failed' ? 'opacity-50' : ''); ?>">
                        <?php echo e(($progress['status'] ?? '') === 'completed' || ($progress['status'] ?? '') === 'failed' ? 'View Project' : 'Continue Anyway'); ?>
