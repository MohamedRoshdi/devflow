        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 transition-colors">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="p-3 rounded-xl
                        <?php if($latestMetric->cpu_usage > 80): ?> bg-red-100 dark:bg-red-900/30
                        <?php elseif($latestMetric->cpu_usage > 60): ?> bg-yellow-100 dark:bg-yellow-900/30
                        <?php else: ?> bg-blue-100 dark:bg-blue-900/30
                        <?php endif; ?>">
                        <svg class="w-6 h-6
                            <?php if($latestMetric->cpu_usage > 80): ?> text-red-600 dark:text-red-400
                            <?php elseif($latestMetric->cpu_usage > 60): ?> text-yellow-600 dark:text-yellow-400
                            <?php else: ?> text-blue-600 dark:text-blue-400
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 transition-colors">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="p-3 rounded-xl
                        <?php if($latestMetric->memory_usage > 80): ?> bg-red-100 dark:bg-red-900/30
                        <?php elseif($latestMetric->memory_usage > 60): ?> bg-yellow-100 dark:bg-yellow-900/30
                        <?php else: ?> bg-green-100 dark:bg-green-900/30
                        <?php endif; ?>">
                        <svg class="w-6 h-6
                            <?php if($latestMetric->memory_usage > 80): ?> text-red-600 dark:text-red-400
                            <?php elseif($latestMetric->memory_usage > 60): ?> text-yellow-600 dark:text-yellow-400
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 transition-colors">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="p-3 rounded-xl
                        <?php if($latestMetric->disk_usage > 80): ?> bg-red-100 dark:bg-red-900/30
                        <?php elseif($latestMetric->disk_usage > 60): ?> bg-yellow-100 dark:bg-yellow-900/30
                        <?php else: ?> bg-purple-100 dark:bg-purple-900/30
                        <?php endif; ?>">
                        <svg class="w-6 h-6
                            <?php if($latestMetric->disk_usage > 80): ?> text-red-600 dark:text-red-400
                            <?php elseif($latestMetric->disk_usage > 60): ?> text-yellow-600 dark:text-yellow-400
                            ...
                            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm font-semibold whitespace-nowrap
                                        <?php if($metric->cpu_usage > 80): ?> text-red-600 dark:text-red-400
                                        <?php elseif($metric->cpu_usage > 60): ?> text-yellow-600 dark:text-yellow-400
                                        <?php else: ?> text-green-600 dark:text-green-400
                                        <?php endif; ?>">
                                        <?php echo e(number_format($metric->cpu_usage, 1)); ?>%
                                    </td>
                                    <td class="px-4 py-3 text-sm font-semibold whitespace-nowrap
                                        <?php if($metric->memory_usage > 80): ?> text-red-600 dark:text-red-400
                                        <?php elseif($metric->memory_usage > 60): ?> text-yellow-600 dark:text-yellow-400
                                        <?php else: ?> text-green-600 dark:text-green-400
                                        <?php endif; ?>">
                                        <?php echo e(number_format($metric->memory_usage, 1)); ?>%
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap">
                                        <?php echo e(number_format($metric->memory_used_mb / 1024, 1)); ?> / <?php echo e(number_format($metric->memory_total_mb / 1024, 1)); ?> GB
                                    </td>
                                    <td class="px-4 py-3 text-sm font-semibold whitespace-nowrap
                                        <?php if($metric->disk_usage > 80): ?> text-red-600 dark:text-red-400
                                        <?php elseif($metric->disk_usage > 60): ?> text-yellow-600 dark:text-yellow-400
                                        <?php else: ?> text-green-600 dark:text-green-400
                                        <?php endif; ?>">
                                        <?php echo e(number_format($metric->disk_usage, 1)); ?>%
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap">
                                        <?php echo e($metric->disk_used_gb); ?> / <?php echo e($metric->disk_total_gb); ?> GB
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap">
                                        <?php echo e($metric->load_average_1); ?>
