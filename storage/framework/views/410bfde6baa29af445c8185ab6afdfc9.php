                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($key->name); ?></h3>
                                <div class="mt-2 space-y-1">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        <span class="font-medium">Type:</span>
                                        <span class="ml-2 px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 rounded text-xs font-semibold uppercase"><?php echo e($key->type); ?></span>
                                    </p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 font-mono break-all">
                                        <span class="font-medium">Fingerprint:</span> <?php echo e($key->fingerprint); ?>

                                    </p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        <span class="font-medium">Created:</span> <?php echo e($key->created_at->format('M d, Y H:i')); ?>
                        ...
                        <?php if($key->servers->count() > 0): ?>
                            <div class="mb-4 p-4 bg-gradient-to-br from-green-500/10 to-emerald-500/10 dark:from-green-500/20 dark:to-emerald-500/20 rounded-lg">
                                <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Deployed to <?php echo e($key->servers->count()); ?> server(s):</h4>
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $key->servers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="inline-flex items-center bg-white dark:bg-gray-700 px-3 py-1 rounded-full text-sm">
                                            <span class="text-gray-900 dark:text-white"><?php echo e($server->name); ?></span>
                                            <button wire:click="removeFromServer(<?php echo e($key->id); ?>, <?php echo e($server->id); ?>)"
                                                    wire:confirm="Are you sure you want to remove this SSH key from <?php echo e($server->name); ?>?"
                        ...
                        <div class="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <button wire:click="openViewKeyModal(<?php echo e($key->id); ?>)"
                            ...
                            <button wire:click="copyPublicKey(<?php echo e($key->id); ?>)"
                            ...
                            <button wire:click="downloadPrivateKey(<?php echo e($key->id); ?>)"
                            ...
                            <button wire:click="openDeployModal(<?php echo e($key->id); ?>)"
                            ...
                            <button wire:click="deleteKey(<?php echo e($key->id); ?>)"
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea readonly
                                      ...
                                      id="generated-public-key"><?php echo e($generatedKey['public_key']); ?></textarea>
                            <button type="button"
                        ...
                        <div>
                            ...
                            <input type="text" readonly value="<?php echo e($generatedKey['fingerprint']); ?>" class="input font-mono text-sm">
                        </div>

                        <div class="flex justify-between">
                            <button type="button"
                                    wire:click="downloadPrivateKey(<?php echo e($generatedKey['id']); ?>)"
                    ...
                    <form wire:submit.prevent="generateKey" class="p-6 space-y-6">
                        <div>
                            ...
                            <input wire:model="newKeyName"
                                   ...
                                   class="input <?php $__errorArgs = ['newKeyName'];
                ...
                <form wire:submit.prevent="importKey" class="p-6 space-y-6">
                    <div>
                        ...
                        <input wire:model="importKeyName"
                               ...
                               class="input <?php $__errorArgs = ['importKeyName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea wire:model="importPublicKey"
                                  ...
                                  class="input font-mono text-sm <?php $__errorArgs = ['importPublicKey'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"></textarea>
                        <?php $__errorArgs = ['importPublicKey'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea wire:model="importPrivateKey"
                                  ...
                                  class="input font-mono text-sm <?php $__errorArgs = ['importPrivateKey'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"></textarea>
                        <?php $__errorArgs = ['importPrivateKey'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <form wire:submit.prevent="deployToServer" class="p-6 space-y-6">
                    <div>
                        ...
                        <select wire:model="selectedServerId"
                                id="selectedServerId"
                                required
                                class="input <?php $__errorArgs = ['selectedServerId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $servers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($server->id); ?>"><?php echo e($server->name); ?> (<?php echo e($server->ip_address); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['selectedServerId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($showViewKeyModal && $viewingKey): ?>
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" wire:click.self="closeModals">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-3xl w-full">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($viewingKey['name']); ?></h2>
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white uppercase"><?php echo e($viewingKey['type']); ?></p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Fingerprint</label>
                        <p class="text-gray-900 dark:text-white font-mono text-sm"><?php echo e($viewingKey['fingerprint']); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea readonly
                                  ...
                                  id="view-public-key"><?php echo e($viewingKey['public_key']); ?></textarea>
                        <button type="button"
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white"><?php echo e($viewingKey['created_at']); ?></p>
                    </div>
...
<script>
    ...
    ?>
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/settings/ssh-key-manager.blade.php ENDPATH**/ ?>