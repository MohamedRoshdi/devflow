                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white/80"><?php echo e($server->name); ?> - Intrusion Prevention</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="p-3 rounded-lg <?php echo e($fail2banEnabled ? 'bg-green-500/20' : 'bg-red-500/20'); ?>">
                            <svg class="w-8 h-8 <?php echo e($fail2banEnabled ? 'text-green-400' : 'text-red-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400">
                                Service is
                                <span class="font-medium <?php echo e($fail2banEnabled ? 'text-green-400' : 'text-red-400'); ?>">
                                    <?php echo e($fail2banEnabled ? 'Running' : 'Stopped'); ?>

                                </span>
                                <?php if(!empty($jails)): ?>
                                    &bull; <?php echo e(count($jails)); ?> jail(s) active
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                    <div>
                        <?php if($fail2banEnabled): ?>
            ...
            <?php if($fail2banEnabled): ?>
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div class="lg:col-span-1 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                        ...
                        <?php else: ?>
                            <div class="space-y-2">
                                <?php $__currentLoopData = $jails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button wire:click="selectJail('<?php echo e($jail); ?>')"
                                        class="w-full text-left px-4 py-3 rounded-lg transition-colors <?php echo e($selectedJail === $jail ? 'bg-red-600 text-white' : 'bg-gray-900/50 text-gray-300 hover:bg-gray-700/50'); ?>">
                                        <?php echo e($jail); ?>
                    ...
                    <div class="lg:col-span-3 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-white">
                                Banned IPs - <?php echo e($selectedJail); ?>

                            </h3>
                            <span class="text-gray-400 text-sm"><?php echo e(count($bannedIPs)); ?> banned</span>
                        </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-700/50">
                                        <?php $__currentLoopData = $bannedIPs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="text-gray-300">
                                                ...
                                                <td class="py-3 text-right">
                                                    <button wire:click="unbanIP('<?php echo e($ip); ?>')"
                                                        wire:confirm="Are you sure you want to unban <?php echo e($ip); ?>?"
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/servers/security/fail2ban-manager.blade.php ENDPATH**/ ?>