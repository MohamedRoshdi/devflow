        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_backups']); ?></p>
                </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['scheduled_backups']); ?></p>
                </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_size']); ?></p>
                </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['last_backup']); ?></p>
                </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="whitespace-nowrap px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($schedule->database_name); ?></span>
                            </div>
                        </td>
                        <td class="whitespace-nowrap px-6 py-4">
                            <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold
                                <?php if($schedule->database_type === 'mysql'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300
                                <?php elseif($schedule->database_type === 'postgresql'): ?> bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300
                                <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300
                                <?php endif; ?>">
                                <?php echo e(strtoupper($schedule->database_type)); ?>

                            </span>
                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($schedule->frequency_label); ?>

                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($schedule->next_run_at?->diffForHumans() ?? 'Not scheduled'); ?>

                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($schedule->last_run_at?->diffForHumans() ?? 'Never'); ?>

                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($schedule->retention_days); ?> days
                        </td>
                        <td class="whitespace-nowrap px-6 py-4">
                            <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold
                                <?php if($schedule->storage_disk === 's3'): ?> bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300
                                <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300
                                <?php endif; ?>">
                                <?php echo e(strtoupper($schedule->storage_disk)); ?>
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            <button wire:click="toggleSchedule(<?php echo e($schedule->id); ?>)"
                                    ...
                                    <?php endif; ?>">
                                <span class="mr-1 h-2 w-2 rounded-full <?php if($schedule->is_active): ?> bg-green-500 <?php else: ?> bg-gray-400 <?php endif; ?>"></span>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="whitespace-nowrap px-6 py-4">
                            <div class="flex items-center">
                                <i class="fas fa-database mr-2 text-gray-400"></i>
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-white"><?php echo e($backup->database_name); ?></div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($backup->file_name); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="whitespace-nowrap px-6 py-4">
                            <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold
                                <?php if($backup->database_type === 'mysql'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300
                                <?php elseif($backup->database_type === 'postgresql'): ?> bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300
                                <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300
                                <?php endif; ?>">
                                <?php echo e(strtoupper($backup->database_type)); ?>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($backup->created_at->diffForHumans()); ?></div>
                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($backup->file_size_human); ?>

                        </td>
                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($backup->duration ?? 'N/A'); ?>

                        </td>
                        <td class="whitespace-nowrap px-6 py-4">
                            <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold
                                <?php if($backup->storage_disk === 's3'): ?> bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300
                                <?php else: ?> bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300
                                <?php endif; ?>">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm">
                            <div class="flex items-center justify-end gap-2">
                                <?php if($backup->status === 'completed'): ?>
                                    ...
                                    <button wire:click="confirmRestoreBackup(<?php echo e($backup->id); ?>)"
