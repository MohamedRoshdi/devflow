<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
            ...
            <code class="text-sm text-gray-700 dark:text-gray-300"><?php echo e(url('/api/v1/projects')); ?></code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <div class="flex justify-between items-center mb-2">
                ...
                <button onclick="navigator.clipboard.writeText('<?php echo e(url('/api/v1/projects')); ?>')"
                        class="text-xs text-blue-400 hover:text-blue-300">Copy</button>
            </div>
            <code class="text-sm text-blue-300">GET <?php echo e(url('/api/v1/projects')); ?></code>
        </div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            ...
            <pre class="text-xs text-gray-300"><code>curl <?php echo e(url('/api/v1/projects?status=running&per_page=20')); ?> \
  ...
  "data": [
    {
      ...
      "links": {
        "self": "<?php echo e(url('/api/v1/projects/my-laravel-app')); ?>",
        "deploy": "<?php echo e(url('/api/v1/projects/my-laravel-app/deploy')); ?>"
      }
    }
  ],
  "meta": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">GET <?php echo e(url('/api/v1/projects/{slug}')); ?></code>
        </div>
  ...
  "data": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">POST <?php echo e(url('/api/v1/projects')); ?></code>
        </div>
  ...
  "auto_deploy": true
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">POST <?php echo e(url('/api/v1/projects/{slug}/deploy')); ?></code>
        </div>
  ...
  "data": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">PUT <?php echo e(url('/api/v1/projects/{slug}')); ?></code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">DELETE <?php echo e(url('/api/v1/projects/{slug}')); ?></code>
        </div>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/docs/partials/projects.blade.php ENDPATH**/ ?>