                ...
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <a href="<?php echo e(route('projects.show', $project)); ?>" class="text-xl font-bold text-gray-900 hover:text-blue-600">
                                    <?php echo e($project->name); ?>

                                </a>
                                <p class="text-sm text-gray-500 mt-1"><?php echo e($project->slug); ?></p>
                            </div>
                            <div class="flex items-center">
                                <span class="w-3 h-3 rounded-full
                                    <?php if($project->status === 'running'): ?> bg-green-500
                                    <?php elseif($project->status === 'stopped'): ?> bg-gray-400
                                    <?php elseif($project->status === 'building'): ?> bg-yellow-500
                                    <?php else: ?> bg-red-500
                                    <?php endif; ?>">
                                </span>
                            </div>
