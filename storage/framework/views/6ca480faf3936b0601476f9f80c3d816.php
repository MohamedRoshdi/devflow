<div>
    ...
    <div class="relative mb-8 rounded-2xl bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 dark:from-green-600 dark:via-emerald-600 dark:to-teal-600 p-8 shadow-xl overflow-hidden">
        ...
        <div class="relative z-10 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="bg-white/20 hover:bg-white/30 backdrop-blur-md text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg">
                + New Project
            </a>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer relative group overflow-hidden"
                     onclick="window.location='<?php echo e(route('projects.show', $project)); ?>'">
                    <!-- Gradient Border Top -->
                    <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r
                        <?php if($project->status === 'running'): ?> from-green-500 to-emerald-600
                        <?php elseif($project->status === 'stopped'): ?> from-gray-400 to-gray-500
                        <?php elseif($project->status === 'building'): ?> from-yellow-500 to-orange-500
                        <?php else: ?> from-red-500 to-red-600
                        <?php endif; ?>">
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <a href="<?php echo e(route('projects.show', $project)); ?>" class="text-xl font-bold text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                    <?php echo e($project->name); ?>

                                </a>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e($project->slug); ?></p>
                            </div>
                            <div class="p-2 rounded-lg
                                <?php if($project->status === 'running'): ?> bg-gradient-to-br from-green-500 to-emerald-600
                                <?php elseif($project->status === 'stopped'): ?> bg-gradient-to-br from-gray-400 to-gray-500
                                <?php elseif($project->status === 'building'): ?> bg-gradient-to-br from-yellow-500 to-orange-500
                                <?php else: ?> bg-gradient-to-br from-red-500 to-red-600
                                <?php endif; ?>">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <?php echo e($project->server->name ?? 'No server'); ?>
                            ...
                            <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <?php echo e($project->framework ?? 'Unknown'); ?>

                            </div>
                            <?php if($project->domains->count() > 0): ?>
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <?php echo e($project->domains->first()->domain); ?>
                        ...
                        <div class="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                            <span class="text-xs text-gray-500 dark:text-gray-400">
                                <?php echo e($project->last_deployed_at ? $project->last_deployed_at->diffForHumans() : 'Never deployed'); ?>
                            ...
                            <div class="flex space-x-2" onclick="event.stopPropagation()">
                                ...
                                <button wire:click="deleteProject(<?php echo e($project->id); ?>)"
                                        ...
                                        wire:target="deleteProject(<?php echo e($project->id); ?>)"
                                        class="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 text-sm font-medium transition-colors">
                                    <span wire:loading.remove wire:target="deleteProject(<?php echo e($project->id); ?>)">Delete</span>
                                    <span wire:loading wire:target="deleteProject(<?php echo e($project->id); ?>)">Deleting...</span>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <?php else: ?>
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl text-center py-12 transition-colors">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="inline-block bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg">
                + New Project
            </a>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/projects/project-list.blade.php ENDPATH**/ ?>