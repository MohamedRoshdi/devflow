        ...
        <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-6 py-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/20 hover:bg-white/30 text-white rounded-full font-semibold transition">
        ...
        <div class="p-6 space-y-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                <div class="p-4 rounded-xl border border-blue-100 bg-blue-50 dark:border-blue-900/60 dark:bg-blue-900/20">
                    ...
                    <p class="mt-2 text-2xl font-bold text-blue-900 dark:text-blue-100"><?php echo e($stats['total']); ?></p>
                </div>
                <div class="p-4 rounded-xl border border-emerald-100 bg-emerald-50 dark:border-emerald-900/60 dark:bg-emerald-900/20">
                    ...
                    <p class="mt-2 text-2xl font-bold text-emerald-900 dark:text-emerald-100"><?php echo e($stats['success']); ?></p>
                </div>
                <div class="p-4 rounded-xl border border-amber-100 bg-amber-50 dark:border-amber-900/60 dark:bg-amber-900/20">
                    ...
                    <p class="mt-2 text-2xl font-bold text-amber-900 dark:text-amber-100"><?php echo e($stats['running']); ?></p>
                </div>
                <div class="p-4 rounded-xl border border-rose-100 bg-rose-50 dark:border-rose-900/60 dark:bg-rose-900/20">
                    ...
                    <p class="mt-2 text-2xl font-bold text-rose-900 dark:text-rose-100"><?php echo e($stats['failed']); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select wire:model.live="perPage" class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm text-gray-700 dark:text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                        <?php $__currentLoopData = [10, 15, 20, 30, 50]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($size); ?>"><?php echo e($size); ?> results</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>

            <?php if($deployments->count()): ?>
                                ...
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                                        <div class="flex-1 space-y-3">
                                            <div class="flex flex-wrap items-center gap-3">
                                                ...
                                                <?php if($deployment->commit_hash): ?>
                                                    <code class="text-xs font-mono bg-gray-900 text-white px-3 py-1.5 rounded-lg"><?php echo e(substr($deployment->commit_hash, 0, 7)); ?></code>
                                                <?php endif; ?>
                                                <span class="inline-flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                    <?php echo e($deployment->created_at->format('M d, Y • H:i')); ?>

                                                    <span class="text-[11px] text-gray-400">(<?php echo e($deployment->created_at->diffForHumans()); ?>)</span>
                                                </span>
                                            </div>
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                                                    ...
                                                    <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($deployment->project->name); ?></span>
                                                </div>
                                                <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                                                    <?php echo e($deployment->commit_message ?? 'No commit message available for this deployment.'); ?>
                                            ...
                                            <div class="flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-gray-800/60">
                                                    ...
                                                    Branch: <span class="font-semibold text-gray-700 dark:text-gray-200"><?php echo e($deployment->branch); ?></span>
                                                </span>
                                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-gray-800/60">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2" />
                                                    </svg>
                                                    Server: <span class="font-semibold text-gray-700 dark:text-gray-200"><?php echo e(optional($deployment->server)->name ?? 'Unknown'); ?></span>
                                                </span>
                                                <?php if($deployment->duration_seconds): ?>
                                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-gray-800/60">
                                                        ...
                                                        Duration: <span class="font-semibold text-gray-700 dark:text-gray-200"><?php echo e(number_format($deployment->duration_seconds / 60, 1)); ?> min</span>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-end lg:items-center">
                                            <a href="<?php echo e(route('deployments.show', $deployment)); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 text-white rounded-lg font-semibold transition">
                                                View Details
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/deployments/deployment-list.blade.php ENDPATH**/ ?>