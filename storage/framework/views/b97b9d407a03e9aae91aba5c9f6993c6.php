<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
            ...
            <code class="text-sm text-gray-700 dark:text-gray-300"><?php echo e(url('/api/v1/servers')); ?></code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">GET <?php echo e(url('/api/v1/servers')); ?></code>
        </div>
  ...
  "data": [
    {
      ...
      "projects_count": 5,
      "links": {
        "self": "<?php echo e(url('/api/v1/servers/1')); ?>",
        "metrics": "<?php echo e(url('/api/v1/servers/1/metrics')); ?>"
      }
    }
  ]
}</code></pre>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4">
            <code class="text-sm text-blue-300">GET <?php echo e(url('/api/v1/servers/{id}')); ?></code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">POST <?php echo e(url('/api/v1/servers')); ?></code>
        </div>
  ...
  "disk_gb": 500
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">GET <?php echo e(url('/api/v1/servers/{id}/metrics')); ?></code>
        </div>
  ...
  "data": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4">
            <code class="text-sm text-blue-300">PUT <?php echo e(url('/api/v1/servers/{id}')); ?></code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">DELETE <?php echo e(url('/api/v1/servers/{id}')); ?></code>
        </div>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/docs/partials/servers.blade.php ENDPATH**/ ?>