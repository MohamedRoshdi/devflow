        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="relative p-6 text-white">
                    ...
                    <p class="text-4xl font-extrabold"><?php echo e($deploymentStats['total']); ?></p>
            ...
            <div class="group relative overflow-hidden bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="relative p-6 text-white">
                    ...
                    <p class="text-4xl font-extrabold"><?php echo e($deploymentStats['successful']); ?></p>
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <p class="text-xs text-white/70">
                            <?php echo e($deploymentStats['total'] > 0 ? round(($deploymentStats['successful'] / $deploymentStats['total']) * 100, 1) : 0); ?>% success rate
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="group relative overflow-hidden bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="relative p-6 text-white">
                    ...
                    <p class="text-4xl font-extrabold"><?php echo e($deploymentStats['failed']); ?></p>
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <p class="text-xs text-white/70">
                            <?php echo e($deploymentStats['total'] > 0 ? round(($deploymentStats['failed'] / $deploymentStats['total']) * 100, 1) : 0); ?>% failure rate
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="relative p-6 text-white">
                    ...
                    <p class="text-4xl font-extrabold"><?php echo e($deploymentStats['avg_duration'] ?? 0); ?><span class="text-xl">s</span></p>
                    <div class="mt-4 pt-4 border-t border-white/20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(round($serverMetrics->avg_cpu ?? 0, 1)); ?>%</span>
                </div>
                <div class="relative">
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-6 overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-6 rounded-full transition-all duration-1000 ease-out flex items-center justify-end px-3"
                             style="width: <?php echo e(min($serverMetrics->avg_cpu ?? 0, 100)); ?>%">
                            <?php if(($serverMetrics->avg_cpu ?? 0) > 10): ?>
                                <span class="text-xs font-bold text-white"><?php echo e(round($serverMetrics->avg_cpu ?? 0, 1)); ?>%</span>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                ?>
                <p class="mt-4 text-sm font-medium <?php echo e($cpuStatus['color']); ?>">
                    Status: <?php echo e($cpuStatus['text']); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(round($serverMetrics->avg_memory ?? 0, 1)); ?>%</span>
                </div>
                <div class="relative">
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-6 overflow-hidden">
                        <div class="bg-gradient-to-r from-green-500 to-emerald-600 h-6 rounded-full transition-all duration-1000 ease-out flex items-center justify-end px-3"
                             style="width: <?php echo e(min($serverMetrics->avg_memory ?? 0, 100)); ?>%">
                            <?php if(($serverMetrics->avg_memory ?? 0) > 10): ?>
                                <span class="text-xs font-bold text-white"><?php echo e(round($serverMetrics->avg_memory ?? 0, 1)); ?>%</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="flex justify-between mt-2 text-xs text-gray-500 dark:text-gray-400">
                ...
                <?php
                    ...
                    $memStatus = $memUsage < 60 ? ['text' => 'Normal', 'color' => 'text-green-600 dark:text-green-400'] :
                                 ...
                                 ['text' => 'Critical', 'color' => 'text-red-600 dark:text-red-400']);
                ?>
                <p class="mt-4 text-sm font-medium <?php echo e($memStatus['color']); ?>">
                    Status: <?php echo e($memStatus['text']); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(round($serverMetrics->avg_disk ?? 0, 1)); ?>%</span>
                </div>
                <div class="relative">
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-6 overflow-hidden">
                        <div class="bg-gradient-to-r from-yellow-500 to-orange-600 h-6 rounded-full transition-all duration-1000 ease-out flex items-center justify-end px-3"
                             style="width: <?php echo e(min($serverMetrics->avg_disk ?? 0, 100)); ?>%">
                            <?php if(($serverMetrics->avg_disk ?? 0) > 10): ?>
                                <span class="text-xs font-bold text-white"><?php echo e(round($serverMetrics->avg_disk ?? 0, 1)); ?>%</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="flex justify-between mt-2 text-xs text-gray-500 dark:text-gray-400">
                ...
                <?php
                    ...
                    $diskStatus = $diskUsage < 70 ? ['text' => 'Normal', 'color' => 'text-green-600 dark:text-green-400'] :
                                  ...
                                  ['text' => 'Critical', 'color' => 'text-red-600 dark:text-red-400']);
                ?>
                <p class="mt-4 text-sm font-medium <?php echo e($diskStatus['color']); ?>">
                    Status: <?php echo e($diskStatus['text']); ?>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p class="text-4xl font-extrabold text-gray-900 dark:text-white"><?php echo e($projectAnalytics['total_projects']); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p class="text-4xl font-extrabold text-green-600 dark:text-green-400"><?php echo e($projectAnalytics['running']); ?></p>
                <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p class="text-4xl font-extrabold text-gray-600 dark:text-gray-400"><?php echo e($projectAnalytics['stopped']); ?></p>
                <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p class="text-4xl font-extrabold text-blue-600 dark:text-blue-400"><?php echo e(round($projectAnalytics['total_storage'] / 1024, 2)); ?><span class="text-xl"> GB</span></p>
                <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/analytics/analytics-dashboard.blade.php ENDPATH**/ ?>