    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if(session()->has('message')): ?>
                <span class="text-sm text-green-600 dark:text-green-400"><?php echo e(session('message')); ?></span>
            <?php endif; ?>
        </div>
                    ...
                    <label class="flex items-center justify-between p-3 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg cursor-pointer hover:shadow-md transition-all duration-200 group">
                        <div class="flex items-center space-x-3 flex-1">
                            <input type="checkbox"
                                   ...
                                   <?php if(in_array($tag['id'], $selectedTags)): ?> checked <?php endif; ?>
                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <div class="w-3 h-3 rounded-full flex-shrink-0" style="background-color: <?php echo e($tag['color']); ?>"></div>
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e($tag['name']); ?></span>
                        </div>
                    </label>
        ...
        <?php else: ?>
            <div class="text-center py-8">
                ...
                <a href="<?php echo e(route('servers.tags')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/servers/server-tag-assignment.blade.php ENDPATH**/ ?>