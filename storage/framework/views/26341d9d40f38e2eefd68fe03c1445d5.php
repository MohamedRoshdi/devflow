<div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Automatically deploy when you push to <?php echo e($project->branch); ?> branch
                </p>
            </div>
            <div>
                <button
                    ...
                    class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                        <?php echo e($webhookEnabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'); ?>">
                    <span class="sr-only">Enable webhooks</span>
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform
                        <?php echo e($webhookEnabled ? 'translate-x-6' : 'translate-x-1'); ?>">
                    </span>
                </button>
            </div>
        </div>
    ...
    <?php if($webhookEnabled && $webhookSecret): ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button
                    onclick="navigator.clipboard.writeText('<?php echo e($webhookUrl); ?>'); alert('Copied to clipboard!')"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                <input
                    ...
                    value="<?php echo e($webhookSecret); ?>"
                    readonly
                    class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800 focus:ring-opacity-50">
                <button
                ...
                <button
                    onclick="navigator.clipboard.writeText('<?php echo e($webhookSecret); ?>'); alert('Secret copied to clipboard!')"
                    class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 transition-colors">
        ...
        <?php if($this->recentDeliveries->count() > 0): ?>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__currentLoopData = $this->recentDeliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300">
                                <?php echo e(ucfirst($delivery->provider)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">
                            <?php echo e($delivery->event_type); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-medium rounded-full
                                <?php if($delivery->status === 'success'): ?> bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400
                                <?php elseif($delivery->status === 'failed'): ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400
                                <?php elseif($delivery->status === 'ignored'): ?> bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <?php if($delivery->deployment_id): ?>
                            <a href="<?php echo e(route('deployments.show', $delivery->deployment_id)); ?>"
                               class="text-blue-600 dark:text-blue-400 hover:underline">
                                #<?php echo e($delivery->deployment_id); ?>
        ...
        <div class="mt-4">
            <?php echo e($this->recentDeliveries->links()); ?>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/projects/project-webhook-settings.blade.php ENDPATH**/ ?>