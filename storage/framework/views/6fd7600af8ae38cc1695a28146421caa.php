<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 p-6 hover:shadow-xl transition-all">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($backupStats['databases_backed_up'] ?? 3); ?></p>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Last: <?php echo e($backupStats['last_backup'] ?? 'Today 02:00'); ?></p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 p-6 hover:shadow-xl transition-all">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(count($recentAlerts)); ?></p>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="-mb-px flex space-x-8 overflow-x-auto">
                <button wire:click="$set('activeTab', 'overview')"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors <?php echo e($activeTab === 'overview' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                ...
                <button wire:click="viewBackupLogs"
                        ...
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors <?php echo e($activeTab === 'backup-logs' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                    <div class="flex items-center space-x-2">
                ...
                <button wire:click="viewMonitoringLogs"
                        ...
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors <?php echo e($activeTab === 'monitoring-logs' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                    <div class="flex items-center space-x-2">
                ...
                <button wire:click="viewOptimizationLogs"
                        ...
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors <?php echo e($activeTab === 'optimization-logs' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                    <div class="flex items-center space-x-2">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($backupStats['last_backup'] ?? 'Today 02:00'); ?></span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                            <span class="text-gray-600 dark:text-gray-400">Databases</span>
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($backupStats['databases_backed_up'] ?? 3); ?></span>
                        </div>
                        <div class="flex items-center justify-between py-3">
                            <span class="text-gray-600 dark:text-gray-400">Total Size</span>
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($backupStats['total_size'] ?? '144K'); ?></span>
                        </div>
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = $recentAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-4 rounded-lg border
                                        <?php if($alert['level'] === 'ERROR' || $alert['level'] === 'CRITICAL'): ?>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($alert['timestamp']); ?></p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-green-400 text-sm font-mono"><?php $__currentLoopData = $backupLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($log); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></pre>
        ...
        <!-- Monitoring Logs Tab -->
        <?php if($activeTab === 'monitoring-logs'): ?>
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto max-h-96 overflow-y-auto">
                        <pre class="text-blue-400 text-sm font-mono"><?php $__currentLoopData = $monitoringLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($log); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></pre>
        ...
        <?php if($activeTab === 'optimization-logs'): ?>
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden">
                <div class="bg-gradient-to-r from-orange-500 to-red-600 p-6">
                ...
                <div class="p-6">
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto max-h-96 overflow-y-auto">
                        <pre class="text-orange-400 text-sm font-mono"><?php $__currentLoopData = $optimizationLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($log); ?>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/admin/system-admin.blade.php ENDPATH**/ ?>