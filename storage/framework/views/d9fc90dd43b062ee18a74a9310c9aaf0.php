<div>
            ...
            <div>
                <button
                    ...
                    class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                        <?php echo e($enabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'); ?>">
                    <span class="sr-only">Enable pipeline CI/CD</span>
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform
                        <?php echo e($enabled ? 'translate-x-6' : 'translate-x-1'); ?>">
                    </span>
                </button>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <!--[if BLOCK]><![endif]--><?php if(count($auto_deploy_branches) > 0): ?>
        <div class="space-y-2">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $auto_deploy_branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between bg-gray-50 dark:bg-gray-700 px-4 py-2 rounded-lg">
                <span class="text-gray-900 dark:text-white font-mono text-sm"><?php echo e($branch); ?></span>
                <button
                    wire:click="removeBranch(<?php echo e($index); ?>)"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <!--[if BLOCK]><![endif]--><?php if(count($skip_patterns) > 0): ?>
        <div class="space-y-2">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $skip_patterns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-lg">
                <span class="text-gray-900 dark:text-white font-mono text-sm"><?php echo e($pattern); ?></span>
                <button
                    wire:click="removeSkipPattern(<?php echo e($index); ?>)"
                    class="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <!--[if BLOCK]><![endif]--><?php if(count($deploy_patterns) > 0): ?>
        <div class="space-y-2">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $deploy_patterns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between bg-green-50 dark:bg-green-900/20 px-4 py-2 rounded-lg">
                <span class="text-gray-900 dark:text-white font-mono text-sm"><?php echo e($pattern); ?></span>
                <button
                    wire:click="removeDeployPattern(<?php echo e($index); ?>)"
                    class="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <!--[if BLOCK]><![endif]--><?php if($webhook_secret): ?>
        <!-- GitHub Webhook URL -->
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                <input
                    type="text"
                    value="<?php echo e($githubWebhookUrl); ?>"
                    readonly
                    class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800 focus:ring-opacity-50">
                <button
                    onclick="navigator.clipboard.writeText('<?php echo e($githubWebhookUrl); ?>'); alert('Copied to clipboard!')"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                <input
                    type="text"
                    value="<?php echo e($gitlabWebhookUrl); ?>"
                    readonly
                    class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800 focus:ring-opacity-50">
                <button
                    onclick="navigator.clipboard.writeText('<?php echo e($gitlabWebhookUrl); ?>'); alert('Copied to clipboard!')"
                    class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                <input
                    type="<?php echo e($showSecret ? 'text' : 'password'); ?>"
                    value="<?php echo e($webhook_secret); ?>"
                    readonly
                    class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800 focus:ring-opacity-50">
                <button
                    ...
                    class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <!--[if BLOCK]><![endif]--><?php if($showSecret): ?>
                ...
                <button
                    onclick="navigator.clipboard.writeText('<?php echo e($webhook_secret); ?>'); alert('Secret copied to clipboard!')"
                    class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
        ...
        <!--[if BLOCK]><![endif]--><?php if($showRegenerateConfirm): ?>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/projects/pipeline-settings.blade.php ENDPATH**/ ?>