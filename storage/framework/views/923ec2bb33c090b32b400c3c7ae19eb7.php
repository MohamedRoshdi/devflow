<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 overflow-hidden">
        ...
        <div class="p-6">
            <?php if(count($rollbackPoints) > 0): ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $rollbackPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="group p-4 rounded-xl border-2 transition-all duration-200
                            ...
                            <?php endif; ?>"
                            <?php if($point['can_rollback']): ?> wire:click="selectForRollback(<?php echo e($point['id']); ?>)" <?php endif; ?>>
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-1">
                                            <code class="text-sm px-2.5 py-1 rounded-lg font-mono font-bold
                                                ...
                                                <?php endif; ?>">
                                                <?php echo e($point['commit_hash'] ? substr($point['commit_hash'], 0, 7) : 'N/A'); ?>
                                        ...
                                        <p class="text-sm font-medium text-gray-900 dark:text-white line-clamp-1">
                                            <?php echo e($point['commit_message'] ?? 'No commit message'); ?>
                                        ...
                                        <div class="flex items-center gap-3 mt-1 text-xs text-gray-500 dark:text-gray-400">
                                            ...
                                            <span class="flex items-center gap-1">
                                                ...
                                                <?php echo e(\Carbon\Carbon::parse($point['deployed_at'])->diffForHumans()); ?>
    ...
    <?php if($showRollbackModal && $selectedDeployment): ?>
                    ...
                    <?php if($comparisonData): ?>
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                                ...
                                <code class="text-sm bg-red-600 text-white px-2 py-1 rounded font-mono"><?php echo e($comparisonData['current']['commit']); ?></code>
                                <p class="mt-2 text-sm text-red-800 dark:text-red-200 line-clamp-2"><?php echo e($comparisonData['current']['message']); ?></p>
                                <p class="text-xs text-red-600 dark:text-red-400 mt-1"><?php echo e($comparisonData['current']['date']); ?></p>
                            </div>
                            ...
                            <div class="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                                ...
                                <code class="text-sm bg-green-600 text-white px-2 py-1 rounded font-mono"><?php echo e($comparisonData['target']['commit']); ?></code>
                                <p class="mt-2 text-sm text-green-800 dark:text-green-200 line-clamp-2"><?php echo e($comparisonData['target']['message']); ?></p>
                                <p class="text-xs text-green-600 dark:text-green-400 mt-1"><?php echo e($comparisonData['target']['date']); ?></p>
                            </div>
                        </div>

                        <!-- Commits to Remove -->
                        <?php if(!empty($comparisonData['commits_to_remove']) && $comparisonData['commits_to_remove'][0] !== ''): ?>
                            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                                <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                                    ...
                                    Commits That Will Be Undone (<?php echo e(count($comparisonData['commits_to_remove'])); ?>)
                                </h4>
                                <div class="max-h-32 overflow-y-auto space-y-1">
                                    <?php $__currentLoopData = $comparisonData['commits_to_remove']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($commit): ?>
                        ...
                        <!-- Files Changed -->
                        <?php if(!empty($comparisonData['files_changed'])): ?>
                            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                                <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Files That Will Change</h4>
                                <div class="max-h-32 overflow-y-auto space-y-1">
                                    <?php $__currentLoopData = $comparisonData['files_changed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-2 text-xs py-1">
                                            <?php if($file['status'] === 'added'): ?>
                                            ...
                                            <?php endif; ?>
                                            <code class="text-gray-600 dark:text-gray-400"><?php echo e($file['path']); ?></code>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="text-sm">
                                ...
                                <ul class="mt-1 text-amber-700 dark:text-amber-300 list-disc list-inside space-y-1">
                                    ...
                                    <li>Checkout commit <code class="font-mono bg-amber-200/50 dark:bg-amber-900/50 px-1 rounded"><?php echo e($selectedDeployment['commit_hash'] ? substr($selectedDeployment['commit_hash'], 0, 7) : 'N/A'); ?></code></li>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/deployments/deployment-rollback.blade.php ENDPATH**/ ?>