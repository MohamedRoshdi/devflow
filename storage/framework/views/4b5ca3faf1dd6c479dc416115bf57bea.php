<div>
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Add New Server</h1>
        <p class="text-gray-600 mt-1">Connect a server to your DevFlow Pro account</p>
    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Username -->
                <div>
                    <label for="username" class="block text-sm font-medium text-gray-700 mb-2">SSH Username</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- SSH Key -->
            <div>
                <label for="ssh_key" class="block text-sm font-medium text-gray-700 mb-2">SSH Private Key (Optional)</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label for="location_name" class="block text-sm font-medium text-gray-700 mb-2">Location Name</label>
