                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $servers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="border rounded-lg p-4 <?php echo e($server_id == $server->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 dark:border-gray-700 hover:border-blue-300'); ?>">
                                    ...
                                    <label class="flex items-center flex-1 cursor-pointer">
                                        ...
                                        <div class="ml-3 flex-1">
                                            <div class="flex items-center">
                                                <span class="font-medium text-gray-900 dark:text-white dark:text-white"><?php echo e($server->name); ?></span>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between pt-6 border-t">
                ...
                <button type="submit"
                    ...
                    <span wire:loading wire:target="updateProject">⏳ Updating Project...</span>
                </button>
            </div>
        </form>
    </div>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/projects/project-edit.blade.php ENDPATH**/ ?>