                                ...
                                <div class="flex flex-wrap gap-1">
                                    <?php $__empty_2 = true; $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <span class="px-2 py-1 text-xs font-medium rounded-full
                                            <?php if($role->name === 'admin'): ?> bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400
                                            <?php elseif($role->name === 'manager'): ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400
                            ...
                            <div class="space-y-2">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center">
                                        <input wire:model="selectedRoles" type="checkbox" value="<?php echo e($role->name); ?>"
                                        ...
                                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300"><?php echo e(ucfirst($role->name)); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<?php /**PATH /home/roshdy/Work/projects/DEVFLOW_PRO/resources/views/livewire/users/user-list.blade.php ENDPATH**/ ?>