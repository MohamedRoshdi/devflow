<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-600">Server: {{ $server->name }}</p>
        </div>
    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8">
            ...
            <button wire:click="switchTab('images')" 
                    class="@if($activeTab === 'images') border-blue-500 text-blue-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                🖼️ Images ({{ count($images) }})
            </button>
            <button wire:click="switchTab('volumes')" 
                    class="@if($activeTab === 'volumes') border-blue-500 text-blue-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                💾 Volumes ({{ count($volumes) }})
            </button>
            <button wire:click="switchTab('networks')" 
                    class="@if($activeTab === 'networks') border-blue-500 text-blue-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                🌐 Networks ({{ count($networks) }})
            </button>
            <button wire:click="switchTab('cleanup')" 
                    class="@if($activeTab === 'cleanup') border-blue-500 text-blue-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                🧹 Cleanup
            </button>
        </nav>
    </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-green-600">{{ $dockerInfo['Images'] ?? 0 }}</div>
                        </div>
