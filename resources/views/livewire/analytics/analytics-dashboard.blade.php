    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $deploymentStats['total'] }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-2xl font-bold text-gray-900">{{ round($serverMetrics->avg_cpu ?? 0, 1) }}%</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-2xl font-bold text-gray-900">{{ round($serverMetrics->avg_memory ?? 0, 1) }}%</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-2xl font-bold text-gray-900">{{ round($serverMetrics->avg_disk ?? 0, 1) }}%</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $projectAnalytics['total_projects'] }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-3xl font-bold text-gray-600 mt-2">{{ $projectAnalytics['stopped'] }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
