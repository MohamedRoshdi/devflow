                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                    <div class="relative h-32 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900">
                        <div class="absolute -bottom-12 left-8">
                            <img src="{{ $this->connection->github_avatar }}"
                                 alt="{{ $this->connection->github_username }}"
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                                    {{ $this->connection->github_username }}
                                </h2>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    Connected {{ $this->connection->created_at->diffForHumans() }}
                                </p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $this->stats['public'] }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $this->stats['private'] }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $this->stats['linked'] }}</p>
                            </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-3 mb-2">
                                            ...
                                            @if($repo->language)
                                                <span class="px-2 py-1 text-xs font-medium {{ $repo->language_color }} text-white rounded-full">
                                                    {{ $repo->language }}
                                                </span>
                                            @endif
                                        ...
                                        <div class="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            <span>Updated {{ $repo->synced_at?->diffForHumans() ?? 'Never' }}</span>
                                        </div>
                                    </div>

                                    <div class="ml-4 flex-shrink-0">
                                        @if($repo->is_linked)
                                            <button wire:click="unlinkProject({{ $repo->id }})"
                                        ...
                                        @else
                                            <button wire:click="openLinkModal({{ $repo->id }})"
                        ...
                        @empty
                            <div class="p-12 text-center">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">
                                    @if($search || $visibilityFilter !== 'all' || $languageFilter !== 'all')
