<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6">
            ...
            {{-- Project Creation Defaults Section --}}
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableSsl')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableSsl ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableSsl ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableWebhooks')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableWebhooks ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableWebhooks ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableHealthChecks')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableHealthChecks ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableHealthChecks ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableBackups')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableBackups ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableBackups ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableNotifications')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableNotifications ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableNotifications ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('defaultEnableAutoDeploy')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->defaultEnableAutoDeploy ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->defaultEnableAutoDeploy ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="flex items-center p-3 border-2 {{ $this->theme === 'dark' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-200 dark:border-gray-600' }} rounded-lg cursor-pointer transition-colors">
                            ...
                            <label class="flex items-center p-3 border-2 {{ $this->theme === 'light' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-200 dark:border-gray-600' }} rounded-lg cursor-pointer transition-colors">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <button type="button" wire:click="$toggle('showWizardTips')"
                                class="relative inline-flex h-8 w-14 rounded-full transition-colors {{ $this->showWizardTips ? 'bg-green-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white transition-transform {{ $this->showWizardTips ? 'translate-x-7' : 'translate-x-1' }} shadow-lg"></span>
                        </button>
                    </div>
