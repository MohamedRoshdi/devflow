    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mb-6 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            @foreach(['local', 'development', 'staging', 'production'] as $env)
                <button wire:click="$set('environment', '{{ $env }}')" 
                    ...
                    <div wire:loading wire:target="$set('environment', '{{ $env }}')" class="absolute inset-0 bg-white dark:bg-gray-800 bg-opacity-75 flex items-center justify-center rounded-lg">
