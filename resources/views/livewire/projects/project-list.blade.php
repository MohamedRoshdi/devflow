<div class="min-h-screen">
    ...
    @if (session()->has('message'))
        <div class="mb-6 bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4 backdrop-blur-sm" role="alert">
    ...
    @if (session()->has('error'))
        <div class="mb-6 bg-red-500/10 border border-red-500/30 rounded-xl p-4 backdrop-blur-sm" role="alert">
            <div class="flex items-center gap-3">
                ...
                <div class="relative p-6">
                    ...
                    <div class="space-y-2.5 mb-4">
                        ...
                        <div class="flex items-center text-sm text-white/90">
                            ...
                            {{ config('app.base_domain', config('app.url')) }}
                        </div>
                    </div>
