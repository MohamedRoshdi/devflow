<div class="min-h-screen">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-3">
                                ...
                                @endif
                                @if($stoppedCount > 0)
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium bg-slate-700/50 text-slate-400 border border-slate-600/30">
               ...
               class="group relative bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl overflow-hidden border border-white/10 shadow-2xl hover:shadow-indigo-500/25 transform hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300">
                ...
                <div class="relative p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <h3 class="text-xl font-bold text-white mb-1">DevFlow Pro</h3>
                    ...
                    <div class="space-y-2.5 mb-4">
                        <div class="flex items-center text-sm text-white/90">
                            <div class="p-1.5 bg-white/20 rounded-lg mr-2">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-white/20">
                        <span class="px-3 py-1.5 bg-emerald-500 rounded-full text-xs font-semibold text-white flex items-center shadow-lg">
                    ...
                    <div class="relative p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-2">
                                    <h3 class="text-lg font-bold text-white truncate group-hover:text-emerald-400 transition-colors">
                                        {{ $project->name }}
                                    </h3>
                                    {{-- Status Badge --}}
                        ...
                        <div class="space-y-2.5 mb-4">
                            <div class="flex items-center text-sm text-slate-300">
                                <div class="p-1.5 bg-blue-500/20 rounded-lg mr-2 flex-shrink-0">
                            ...
                            <div class="flex items-center text-sm text-slate-300">
                                <div class="p-1.5 bg-purple-500/20 rounded-lg mr-2 flex-shrink-0">
                            ...
                            @if($project->domains->count() > 0)
                                <div class="flex items-center text-sm text-slate-300">
                                    <div class="p-1.5 bg-emerald-500/20 rounded-lg mr-2 flex-shrink-0">
    ...
    @else
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 shadow-xl text-center py-16" wire:loading.remove>
            <div class="relative inline-flex items-center justify-center w-20 h-20 mb-6">
                <div class="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-full blur-xl"></div>
                <div class="relative p-4 bg-slate-700/50 rounded-2xl">
                    <svg class="w-10 h-10 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
