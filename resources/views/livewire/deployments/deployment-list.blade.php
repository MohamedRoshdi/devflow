        ...
        <div class="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl shadow-slate-900/60 border border-slate-700/50 overflow-hidden">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-5">
                    <div class="group relative p-5 rounded-2xl border border-blue-400/30 bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="group relative p-5 rounded-2xl border border-emerald-400/30 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 backdrop-blur-sm hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="group relative p-5 rounded-2xl border border-amber-400/30 bg-gradient-to-br from-amber-500/10 to-amber-600/5 backdrop-blur-sm hover:shadow-lg hover:shadow-amber-500/20 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="group relative p-5 rounded-2xl border border-rose-400/30 bg-gradient-to-br from-rose-500/10 to-rose-600/5 backdrop-blur-sm hover:shadow-lg hover:shadow-rose-500/20 transition-all duration-300 hover:-translate-y-1">
                        <div class="absolute inset-0 bg-gradient-to-br from-rose-500/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <div class="bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 shadow-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Project</label>
                            <select wire:model.live="projectFilter" class="w-full px-4 py-3 rounded-xl border border-slate-600/50 bg-slate-900/50 backdrop-blur-sm text-sm text-slate-200 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all">
                        ...
                        <div>
                            ...
                            <select wire:model.live="statusFilter" class="w-full px-4 py-3 rounded-xl border border-slate-600/50 bg-slate-900/50 backdrop-blur-sm text-sm text-slate-200 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Per Page</label>
                            <select wire:model.live="perPage" class="w-full px-4 py-3 rounded-xl border border-slate-600/50 bg-slate-900/50 backdrop-blur-sm text-sm text-slate-200 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all">
                                        ...
                                        <div class="relative flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
                                            <div class="flex-1 space-y-4">
                                                ...
                                                <div class="flex flex-wrap items-center gap-3">
                                                    <span @class([
                                                        ...
                                                        @if($deployment->status === 'success')
                                                            <svg class="w-4 h-4 drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path>
                                                            </svg>
                                                        @elseif($deployment->status === 'running')
                                                            <svg class="w-4 h-4 animate-spin drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        @elseif($deployment->status === 'pending')
                                                            <svg class="w-4 h-4 animate-pulse drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                            </svg>
                                                        @else
                                                            <span class="w-2 h-2 rounded-full bg-white drop-shadow-lg"></span>
                                                        @endif
                                                        {{ ucfirst($deployment->status) }}
                                                    </span>

                                                    @if($deployment->commit_hash)
                                                        <code class="text-xs font-mono bg-slate-900/80 backdrop-blur-sm text-cyan-300 px-4 py-2 rounded-lg border border-cyan-500/30 shadow-lg">{{ substr($deployment->commit_hash, 0, 7) }}</code>
                                                    @endif
                                                ...
                                                <div class="flex flex-wrap items-center gap-3 text-xs pl-7">
                                                    <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-700/50 backdrop-blur-sm border border-slate-600/50 text-slate-300">
