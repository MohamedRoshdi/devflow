<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        @if($this->scheduledDeployments->isEmpty())
        ...
        @else
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                @foreach($this->scheduledDeployments as $scheduled)
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                                    Scheduled by {{ $scheduled->user->name ?? 'Unknown' }}
                                    @if($scheduled->notify_before)
                                        &bull; Notify {{ $scheduled->notify_minutes }}min before
                                    @endif
                                </p>
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                @if($scheduled->canCancel())
                                    <button wire:click="cancelScheduledDeployment({{ $scheduled->id }})"
                                ...
                                @if($scheduled->deployment_id)
                                    <a href="{{ route('deployments.show', $scheduled->deployment_id) }}"
                    ...
                    <form wire:submit="scheduleDeployment" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select wire:model="timezone"
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-purple-500 focus:border-purple-500">
                                @foreach($this->timezoneOptions as $tz => $label)
