<div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input wire:model="newTagName"
                           ...
                           maxlength="50"
                           class="input @error('newTagName') border-red-500 @enderror">
                    @error('newTagName')
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <input wire:model="newTagColor"
                               ...
                               placeholder="#6366f1"
                               maxlength="7"
                               class="input flex-1 @error('newTagColor') border-red-500 @enderror">
                    </div>
                    @error('newTagColor')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
    ...
    @if(count($tags) > 0)
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 p-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Your Tags ({{ count($tags) }})</h2>
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg p-4 hover:shadow-md transition-all duration-200">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center space-x-3 flex-1 min-w-0">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-white truncate">{{ $tag['name'] }}</span>
                            </div>
                        </div>

                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600 dark:text-gray-400">
                                {{ $tag['servers_count'] }} {{ $tag['servers_count'] === 1 ? 'server' : 'servers' }}
                            </span>
                ...
                <form wire:submit.prevent="updateTag" class="space-y-4">
                    <div>
                        ...
                        <input wire:model="editTagName"
                               type="text"
                               maxlength="50"
                               class="input @error('editTagName') border-red-500 @enderror">
                        @error('editTagName')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <input wire:model="editTagColor"
                                   type="text"
                                   maxlength="7"
                                   class="input flex-1 @error('editTagColor') border-red-500 @enderror">
                        </div>
                        @error('editTagColor')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
