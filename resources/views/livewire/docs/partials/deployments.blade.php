<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
            ...
            <code class="text-sm text-gray-700 dark:text-gray-300">{{ url('/api/v1') }}</code>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">GET {{ url('/api/v1/projects/{slug}/deployments') }}</code>
        </div>
  ...
  "data": [
    {
      ...
      "links": {
        "self": "{{ url('/api/v1/deployments/42') }}",
        "rollback": "{{ url('/api/v1/deployments/42/rollback') }}"
      }
    }
  ],
  "meta": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">GET {{ url('/api/v1/deployments/{id}') }}</code>
        </div>
  ...
  "data": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">POST {{ url('/api/v1/projects/{slug}/deployments') }}</code>
        </div>
  ...
  "data": {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-4">
            <code class="text-sm text-blue-300">POST {{ url('/api/v1/deployments/{id}/rollback') }}</code>
        </div>
