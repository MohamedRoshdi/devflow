<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">
            ...
            <a href="{{ route('settings.api-tokens') }}" class="text-blue-600 dark:text-blue-400 hover:underline">API Tokens</a> page.
        </p>
        ...
        <div class="mt-6 grid grid-cols-2 gap-4">
            <div>
                ...
                <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                    ...
                    <pre class="text-xs text-gray-300"><code>curl {{ url('/api/v1/projects') }} \
  ...
  -H "Accept: application/json"</code></pre>
            ...
            <div>
                ...
                <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                    <button onclick="navigator.clipboard.writeText(this.nextElementSibling.textContent)"
                            class="text-xs text-blue-400 hover:text-blue-300 float-right">Copy</button>
                    <pre class="text-xs text-gray-300"><code>fetch('{{ url('/api/v1/projects') }}', {
  headers: {
