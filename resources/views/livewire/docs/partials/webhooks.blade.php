<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-6">
            <div class="flex justify-between items-center mb-2">
                ...
                <button onclick="navigator.clipboard.writeText('{{ url('/webhooks/github/{secret}') }}')"
                        class="text-xs text-blue-400 hover:text-blue-300">Copy</button>
            </div>
            <pre class="text-sm text-gray-300"><code>POST {{ url('/webhooks/github/{secret}') }}</code></pre>
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
            <ol class="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                ...
                <li>Enter the Payload URL: <code class="bg-gray-200 dark:bg-gray-800 px-2 py-1 rounded text-xs">{{ url('/webhooks/github/YOUR_SECRET') }}</code></li>
  ...
  "error": "Invalid webhook secret"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-6">
            <div class="flex justify-between items-center mb-2">
                <span class="text-xs text-gray-400 font-semibold">WEBHOOK URL</span>
                <button onclick="navigator.clipboard.writeText('{{ url('/webhooks/gitlab/{secret}') }}')"
                        class="text-xs text-blue-400 hover:text-blue-300">Copy</button>
            </div>
            <pre class="text-sm text-gray-300"><code>POST {{ url('/webhooks/gitlab/{secret}') }}</code></pre>
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
            <ol class="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                ...
                <li>Enter the URL: <code class="bg-gray-200 dark:bg-gray-800 px-2 py-1 rounded text-xs">{{ url('/webhooks/gitlab/YOUR_SECRET') }}</code></li>
  ...
  "commits": [
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 mb-6">
            <pre class="text-sm text-gray-300"><code>POST {{ url('/api/webhooks/deploy/{token}') }}</code></pre>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto mb-4">
            ...
            <pre class="text-xs text-gray-300"><code>curl -X POST {{ url('/webhooks/github/YOUR_SECRET') }} \
