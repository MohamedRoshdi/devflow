 ...
 * onboarding, widget management, user preferences, and dashboard-level data.
 *
 * Child components (self-contained with their own data loading):
 ...
 * - DashboardCacheStats: Cache performance metrics
 *
...
class Dashboard extends Component
{
    ...
    // Deployment timeline data (7-day chart - parent responsibility)
